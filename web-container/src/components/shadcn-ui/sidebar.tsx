...
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from '#components/shadcn-ui/sheet.tsx';
...
function SidebarContent({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'no-scrollbar md:scrollbar-thin-6 flex min-h-0 flex-1 flex-col gap-0 overflow-auto group-data-[collapsible=icon]:overflow-hidden',
        className
      )}
      {...props}
    />
