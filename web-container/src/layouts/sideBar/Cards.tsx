...
export function Cards({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
    <Sidebar
      collapsible='none'
      className='bottom-(--footer-height) h-[calc(100svh-var(--header-height)-var(--footer-height))]! border-l lg:flex'
      {...props}
    >
