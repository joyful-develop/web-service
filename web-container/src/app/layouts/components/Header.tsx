...
export function Header() {
  ...
  return (
    <header className='z-40 flex h-16 shrink-0 items-center justify-between border-b border-gray-200 bg-white px-6 shadow-sm select-none'>
      {/* ================= 좌측 세션: 브랜드 및 시스템 정보 ================= */}
      <div className='flex items-center gap-4'>
        ...
        <div className='flex items-center gap-3'>
          <div className='flex h-8 w-8 items-center justify-center rounded-xl bg-blue-600 text-sm font-black text-white shadow-md shadow-blue-200'>
            FO
          </div>
          <div className='flex flex-col'>
            <div className='flex items-center gap-2'>
              <span className='text-sm font-bold tracking-tight text-gray-900'>FlexOps</span>
      ...
      <div className='flex items-center gap-4'>
        ...
        <button
          ...
          title='화면 새로고침'
          className='group/refresh rounded-lg p-2 text-gray-500 transition-all hover:bg-gray-100 hover:text-gray-800 active:scale-95'>
        ...
        <div className='group/noti relative'>
          <button className='relative rounded-lg p-2 text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-800'>
        ...
        <div className='group/profile relative'>
          <div className='flex cursor-pointer items-center gap-3 rounded-xl border border-transparent p-1 transition-colors hover:border-gray-100 hover:bg-gray-50'>
            ...
            <div className='flex hidden flex-col text-left sm:flex'>
              <span className='text-xs leading-tight font-semibold text-gray-800'>김유저 책임</span>
              <span className='text-[10px] font-medium tracking-wide text-gray-400'>Workspace Admin</span>
            </div>
          </div>
